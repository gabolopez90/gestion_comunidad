...
namespace GestionComunidad.Views
{
    ...
    /// </summary>
    public partial class Incorporacion : UserControl
    {
        List<BcvModel> bcv;
        ...
        public Incorporacion()
        {
            ...
            try
            {
                dataArchivado = SQLiteDataAccess.CargaResponsablesCond();
        ...
        private void Archivar_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                SQLiteArchivar.PagoCondominio(NOMBRE, EDIFICIO, APARTAMENTO, MES, MONTO_USD, MONTO_BS, FECHA_PAGO, OBSERVACIONES);
